  ...
  <div class="create box-shadow">
    ...
    <div v-if="!isPC">
      <div class="content-left">
        ...
        <!--</template>-->
        <!--</div>-->
        <!--&lt;!&ndash;<div class="arrow-wrapper">&ndash;&gt;-->
        <!--&lt;!&ndash;<img src="../../../assets/img/RightAeeow.svg" alt="right-arrow">&ndash;&gt;-->
        <!--&lt;!&ndash;</div>&ndash;&gt;-->
        <!--</div>-->
        <!--</div>-->
        ...
        <div class="input-warpper flex justify-between items-center">
          <div class="mortgage">
            {{ $t('build-Deposit') }}
          </div>
          <div class="pull-right">
      ...
      <div class="content-right mrg-t-20">
        <div class="build-grid-2 mrg-b-5">
          <div class="f-size-20">
            {{ $t('vault-collateral') }}：
          </div>
